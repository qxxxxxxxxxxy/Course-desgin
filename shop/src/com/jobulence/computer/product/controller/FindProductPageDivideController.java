...
public class FindProductPageDivideController {
	...
	public void pageDivide(HttpServletResponse rs,@RequestParam("num") String a,HttpSession session) {
		...
		public void ComputerPageDivide(HttpServletResponse rs,@RequestParam("num") String a,HttpSession session) {
			int c = Integer.parseInt(a);
			if(c > 3) {
				c = 3;
			}
		...
		public void PhonePageDivide(HttpServletResponse rs,@RequestParam("num") String a,HttpSession session) {
			int c = Integer.parseInt(a);
			if(c > 3) {
				c = 3;
			}
		...
		@RequestMapping("/Tv")
		public void TvPageDivide(HttpServletResponse rs,@RequestParam("num") String a,HttpSession session) {
			int c = Integer.parseInt(a);
			if(c > 3) {
				c = 3;
			}
		...
		public void MacbookPageDivide(HttpServletResponse rs,@RequestParam("num") String a,HttpSession session) {
			int c = Integer.parseInt(a);
			if(c > 3) {
				c = 3;
			}
		...
		public void AirConditonerPageDivide(HttpServletResponse rs,@RequestParam("num") String a,HttpSession session) {
			int c = Integer.parseInt(a);
			if(c > 3) {
				c = 3;
			}
			...
			ArrayList<Product> list =(ArrayList<Product>)this.findProductService.findAirConditonerProductPageDivideService(c);
			session.setAttribute("list", list);
			session.setAttribute("num",c);
			try {
				rs.sendRedirect("../shop.jsp");
		...
		public void PlaystationPageDivide(HttpServletResponse rs,@RequestParam("num") String a,HttpSession session) {
			int c = Integer.parseInt(a);
			if(c > 3) {
				c = 3;
			}
			...
			ArrayList<Product> list =(ArrayList<Product>)this.findProductService.findPlayStationProductPageDivideService(c);
			session.setAttribute("list", list);
			session.setAttribute("num",c);
			try {
				rs.sendRedirect("../shop.jsp");
		...
		@RequestMapping("/Ipad")
		public void IpadPageDivide(HttpServletResponse rs,@RequestParam("num") String a,HttpSession session) {
			int c = Integer.parseInt(a);
			if(c > 3) {
				c = 3;
			}
