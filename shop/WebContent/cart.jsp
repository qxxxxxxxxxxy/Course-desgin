                ...
                <div class="col-md-4">
                    ...
                    <div class="single-sidebar">
                        ...
                        <div class="thubmnail-recent">
                            ...
                            <h2><a href="${s}/single-product.jsp">Sony Smart TV - 2015</a></h2>
                        ...
                        <div class="thubmnail-recent">
                            <img src="${s}/img/product-thumb-1.jpg" class="recent-thumb" alt="">
                            <h2><a href="${s}/single-product.jsp">Sony Smart TV - 2015</a></h2>
                            <div class="${s}/product-sidebar-price">
                                <ins>$700.00</ins> <del>$800.00</del>
                            </div>                             
                        </div>
                        <div class="thubmnail-recent">
                                    ...
                                    <c:forEach items="${cartList }" var="c">
                                        <tr class="cart_item">
                                            <td class="product-remove">
                                                <a title="Remove this item" class="remove" href="delteCart?cname=${c.name}">×</a> 
                                            </td>

                                            <td class="product-thumbnail">
                                                <a href="${s}/product/findByName?name=${c.name}"><img width="145" height="145" alt="poster_1_up" class="shop_thumbnail" src="${s}/${c.img}"></a>
                                            </td>

                                            <td class="product-name">
                                                <a href="${s}/product/findByName?name=${c.name}" ><input type="text" name="abcname" value="${c.name}"></a> 
                                            </td>
                                            ...
                                            <td class="product-quantity">
                                                <div class="quantity buttons_added">
                                                    <input type="number"  name="nnn" class="input-text qty text" title="Qty" value="${c.count }" size="4" min="1" step="1">
                                                </div>
                                            </td>

                                            <td class="product-subtotal">
                                                <span class="amount">${c.price * c.count}</span> 
                                            </td>
                                        </tr>
                                        </c:forEach>
                                        <tr>
