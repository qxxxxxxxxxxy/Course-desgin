                ...
                <div class="col-md-3 col-sm-6">
                    <div class="single-shop-product">
                        <div class="product-upper">
                            <img src="${s}/${a.img1}" alt="">
                        </div>
                        <h2><a href="product/findByName?name=${a.name}">${a.name}</a></h2>
                        <div class="product-carousel-price">
                            <ins>$${a.discount}</ins> <del>$${a.price}</del>
                        </div>  
                        
                        <div class="product-option-shop">
                            <a class="add_to_cart_button" data-quantity="1" data-product_sku="" data-product_id="70" rel="nofollow" href="addTocart?productname=${a.name }">Add to cart</a>
                        </div>                       
                    </div>
                </div>
                </c:forEach>
